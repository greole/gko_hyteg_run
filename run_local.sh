...
mpirun ./Tokamak Tokamak.prm -Parameters.minLevel=3 -Parameters.maxLevel=6 -Parameters.coarseGridSolverType=cg_ginkgo \
  ...
  -Parameter.relativeResidualReduction=1e-6 -Parameters.jsonFileName=TokamakTiming-PA-gingko-3-6.json > Tokamak.log &
